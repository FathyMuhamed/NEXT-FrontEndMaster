...
type IProjectWithTasks = Prisma.ProjectGetPayload<typeof projectWithTasks>;


const ProjectCard: FC<{ project: IProjectWithTasks }> = ({ project }) => {

  const completedCount: number = project.tasks.filter((task: Task) => task.status === TASK_STATUS.COMPLETED).length;
